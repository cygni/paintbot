...
public class TournamentManager {
    ...
    private final GameSettingsMapper gameSettingsMapper;
...
//    }
    ...
    private void completeTournament() {
        ...
        InternalGameEvent tournamentEventEnded = new InternalGameEvent(this, Clock.systemUTC(), tee);
...
//        RemotePlayer remotePlayer = new RemotePlayer(player, outgoingEventBus);
        ...
        GameSettings gameSettings = gameSettingsMapper.gameFeaturesToGameSettings(gameFeatures);
...
//        globalEventBus.post(getTournamentPlan());
    ...
    public GameSettings getGameSettings() {
        return gameSettingsMapper.gameFeaturesToGameSettings(gameFeatures);
    }
