...
public class ArenaExplodingPaintPlayer extends BasePaintbotClient {

    private static Logger log = LoggerFactory
            .getLogger(ArenaExplodingPaintPlayer.class);
...
//    private int port = 80;
    private GameMode gameMode = GameMode.ARENA;
    ...
    public static void main(String[] args) {
        ...
        Runnable task = () -> {
            ...
            ArenaExplodingPaintPlayer sp = new ArenaExplodingPaintPlayer();
            sp.connect();
    ...
    public ArenaExplodingPaintPlayer() {
