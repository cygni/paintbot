...
public class ArenaPaintbotPlayer extends BasePaintbotClient {

    private static Logger log = LoggerFactory
            .getLogger(ArenaPaintbotPlayer.class);
...
//    private int port = 80;
    ...
    public static void main(String[] args) {
        ...
        Runnable task = () -> {
            ...
            ArenaPaintbotPlayer sp = new ArenaPaintbotPlayer();
            sp.connect();
